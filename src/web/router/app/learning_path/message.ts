export const messages = {
  en: {
    title: {
      "small-icon": "Choose Your Path to Success",
  ...
  fr: {
    title: {
      "small-icon": "Choisissez votre chemin vers le succès",
      title: "Votre parcours d'apprentissage commence ici",
      description:
  ...
  ar: {
    title: {
      "small-icon": "اختر مسارك للنجاح",
      title: "يبدأ رحلتك التعليمية هنا",
      description:
